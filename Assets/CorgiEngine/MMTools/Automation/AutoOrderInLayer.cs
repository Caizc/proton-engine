...
namespace MoreMountains.Tools
{
	...
	public class AutoOrderInLayer : MonoBehaviour 
	{
		...
		[Header("Children")]
		[Information("And here you can decide to apply your new layer order to all children.",MoreMountains.Tools.InformationAttribute.InformationType.Info,false)]
